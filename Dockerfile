...
COPY *.patch /pytorch/
RUN cd pytorch && patch -p1 --ignore-whitespace --fuzz 3 < 0001-Convert-ld-to-zu-in-python_function.cpp-for-the-same.patch && patch --ignore-whitespace --fuzz 3 -p1 < 0002-Use-zu-instead-of-ld-because-ld-in-python_arg_parser.patch && patch --ignore-whitespace --fuzz 3 -p1 < '101922.patch'
