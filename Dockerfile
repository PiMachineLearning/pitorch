...
RUN mkdir pytorch && wget https://github.com/pytorch/pytorch/releases/download/v2.0.1/pytorch-v2.0.1.tar.gz && tar -zxf pytorch-v2.0.1.tar.gz --strip-components=1 -C pytorch
